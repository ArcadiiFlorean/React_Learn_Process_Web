  ...
  return (
    <section className="bg-[#2E2E2E] text-white py-20 px-6">
      <div className="max-w-[1140px] mx-auto grid md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          <h2 className="text-4xl font-bold mb-6 leading-tight">Built for outperformance.</h2>
          <p className="text-gray-300 mb-6">
            COVID-19 and the developing global dynamic is forcing firms to rethink how they view technology.
          </p>
          <ul className="text-gray-200 space-y-3 mb-6">
            <li className="flex items-center gap-2">
             <img src="/ckeckmark.png" alt="" />gets technological hurdles
            </li>
            <li className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {/* Beneficiu 1 */}
          <div>
            <div className="text-3xl mb-2"><img src="/security-user.png" alt="security-user" /></div>
          ...
          {/* Beneficiu 2 */}
          <div>
            <div className="text-3xl mb-2"><img src="/layer.png" alt="layer" /></div>
          ...
          {/* Beneficiu 3 */}
          <div>
            <div className="text-3xl mb-2"><img src="/emoji-happy.png" alt="emoji-happy" /></div>
          ...
          {/* Beneficiu 4 */}
          <div>
            <div className="text-3xl mb-2"><img src="/data-2.png" alt="data-2" /></div>
